    ...
    <div className="h-full flex flex-col bg-white border-l border-slate-200 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200 bg-white">
        ...
        <div className="flex items-center gap-1.5">
          <Button variant="ghost" size="icon" className="h-8 w-8 text-slate-500 border rounded-md hover:bg-slate-50" onClick={handleDownloadPDF}>
            <Download className="h-4 w-4" />
          </Button>
          <Button variant="ghost" size="icon" className="h-8 w-8 text-slate-500 border rounded-md hover:bg-slate-50" onClick={handlePrint}>
      ...
      {purchaseOrder.billedStatus !== 'BILLED' && (
        <div className="px-4 py-4 bg-blue-50/40 border-b border-blue-100 flex items-center gap-3">
          <div className="bg-blue-100 p-1.5 rounded-full">
            <Plus className="h-3.5 w-3.5 text-blue-600" />
          </div>
          <div className="flex flex-col">
            <span className="text-blue-600 text-[10px] font-bold tracking-widest uppercase leading-none mb-1">✨ WHAT'S NEXT?</span>
          ...
          <div className="flex gap-2 ml-auto">
            {purchaseOrder.status?.toUpperCase() === 'DRAFT' ? (
              <>
                <Button
                  size="sm"
                  className="bg-blue-600 hover:bg-blue-700 h-8 text-xs font-medium px-4"
                  onClick={() => { }}
                >
                  Send Purchase Order
                </Button>
