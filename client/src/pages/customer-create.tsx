            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                  <div className="bg-blue-50 border border-blue-100 px-4 py-3 rounded-md flex items-center gap-2 text-sm text-blue-700 mb-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden mt-8">
                <Tabs defaultValue="other_details" className="w-full">
                  ...
                  <div className="p-6">
                    ...
                    <TabsContent value="reporting_tags" className="space-y-6">
                      <div className="text-center py-8 text-slate-500">
